    ...
    GatewayConfig {
        ...
        providers: vec![
            ...
            ProviderConfig {
                ...
                api_key_envs: vec!["GEMINI_API_KEY".to_string(), "GOOGLE_API_KEY".to_string()],
                enabled: false,
            ...
            ProviderConfig {
                ...
                base_url: String::new(),
                api_key_envs: vec!["COPILOT_GITHUB_TOKEN".to_string(), "GH_TOKEN".to_string()],
                enabled: false,
            ...
            // ── OpenAI-compatible providers (from OpenClaw) ──────────────
            ProviderConfig {
                name: "huggingface".to_string(),
                base_url: "https://router.huggingface.co/v1".to_string(),
                api_key_envs: vec!["HUGGINGFACE_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
            ...
            ProviderConfig {
                ...
                api_key_envs: vec!["VENICE_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
            ...
            ProviderConfig {
                ...
                api_key_envs: vec!["NVIDIA_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
                models: vec!["nvidia/llama-3.1-nemotron-70b-instruct".into()],
                model_metadata: None,
            },
            ProviderConfig {
                name: "moonshot".to_string(),
                base_url: "https://api.moonshot.ai/v1".to_string(),
                api_key_envs: vec!["MOONSHOT_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
                models: vec!["kimi-k2.5".into()],
                model_metadata: None,
            },
            ProviderConfig {
                name: "qianfan".to_string(),
                base_url: "https://qianfan.baidubce.com/v2".to_string(),
                api_key_envs: vec!["QIANFAN_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
                models: vec!["deepseek-v3.2".into()],
                model_metadata: None,
            },
            ProviderConfig {
                name: "volcengine".to_string(),
                base_url: "https://ark.cn-beijing.volces.com/api/v3".to_string(),
                api_key_envs: vec!["VOLCENGINE_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
            ...
            ProviderConfig {
                name: "byteplus".to_string(),
                base_url: "https://ark.ap-southeast.bytepluses.com/api/v3".to_string(),
                api_key_envs: vec!["BYTEPLUS_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
            ...
            ProviderConfig {
                ...
                api_key_envs: vec!["KILOCODE_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
            ...
            ProviderConfig {
                ...
                api_key_envs: vec!["OPENCODE_ZEN_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::OpenAiCompatible,
                extra_headers: HashMap::new(),
                rate_limit: None,
            ...
            // ── Anthropic-wire providers ─────────────────────────────────
            ProviderConfig {
                name: "minimax".to_string(),
                base_url: "https://api.minimax.io/anthropic".to_string(),
                api_key_envs: vec!["MINIMAX_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::Anthropic,
                extra_headers: HashMap::new(),
                rate_limit: None,
                models: vec!["MiniMax-M2.1".into(), "MiniMax-VL-01".into()],
                model_metadata: None,
            },
            ProviderConfig {
                name: "xiaomi".to_string(),
                base_url: "https://api.xiaomimimo.com/anthropic".to_string(),
                api_key_envs: vec!["XIAOMI_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::Anthropic,
                extra_headers: HashMap::new(),
                rate_limit: None,
            ...
            ProviderConfig {
                ...
                base_url: "https://api.synthetic.new/anthropic".to_string(),
                api_key_envs: vec!["SYNTHETIC_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::Anthropic,
                extra_headers: HashMap::new(),
                rate_limit: None,
            ...
            ProviderConfig {
                ...
                api_key_envs: vec!["KIMI_CODING_API_KEY".to_string()],
                enabled: false,
                provider_type: ProviderType::Anthropic,
                extra_headers: HashMap::new(),
                rate_limit: None,
                models: vec!["k2p5".into()],
                model_metadata: None,
            },
        ],
        reliability: None,
